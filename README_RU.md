...
Выбранный REALITY target автоматически проверяется до сохранения настроек. Если
не проходят требования TLS 1.3/h2, интерактивная установка предложит другой
target. Если обнаружен только post-handshake сигнал сравнения, можно оставить
явно выбранный target или сразу ввести другой. Режим `--yes` не может задавать
