...
зависимостей, но всё равно выполнит его до сохранения настроек. Если не проходят
требования TLS 1.3/h2, интерактивная установка предложит другой target. Если
обнаружен только post-handshake сигнал сравнения, можно оставить явно выбранный
target или сразу ввести другой. Режим `--yes` не может задавать вопросы на этапе
аудита: он только пропускает финальное подтверждение. Для обычной установки с
вопросами его указывать не нужно.
